...
S = T*L*2 + T*B*2;      % Wetted surface area (m^2) (Box)
...
% Nonlinear surge damping coefficients
epsilon = 0.001; % To ensure we do not divide by 0 when nu(1)=0
k = 0.1;
Cr = 0;
v = 10^(-6); % Kinematic viscocity (m/s^2)
